	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$('#table').datagrid({
				...
				// 标题
				columns:[[
			       {title:'基本信息',colspan:5,align:'center'},
			       {title:'兴趣爱好',colspan:3,align:'center'}
				],[
					{title:'姓名',field:'name',fit:true},
					{title:'地址',field:'address'},
					{title:'邮箱',field:'email'},
					{title:'性别',field:'sex'},
					{title:'国家',field:'country'},
					{title:'篮球',field:'basktball',formatter:function(value,rec){
							if(value){
								return "<image src='ok.png'/>";
							}else{
								return "<image src='no.png'/>";
							}	
					}},
					{title:'足球',field:'football',formatter:function(value,rec){
							if(value){
								return "<image src='ok.png'/>";
							}else{
								return "<image src='no.png'/>";
					...
					{title:'乒乓球',field:'pingpang',formatter:function(value,rec){
							if(value){
								return "<image src='ok.png'/>";
							}else{
								return "<image src='no.png'/>";
